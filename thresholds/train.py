...
for epoch in range(epochs):
    ...
    # 打印当前两个阈值参数的值
    threshold1 = model.optical_net.nonlinear1.threshold.item()
    threshold2 = model.optical_net.nonlinear2.threshold.item()
    print(f"Current Thresholds - Layer1: {threshold1:.4f}, Layer2: {threshold2:.4f}")
...
# 打印最佳模型的阈值参数
best_threshold1 = model.optical_net.nonlinear1.threshold.item()
best_threshold2 = model.optical_net.nonlinear2.threshold.item()
print(f"Best Model Thresholds - Layer1: {best_threshold1:.4f}, Layer2: {best_threshold2:.4f}")
...
# 打印模型的最终阈值参数
final_threshold1 = model.optical_net.nonlinear1.threshold.item()
final_threshold2 = model.optical_net.nonlinear2.threshold.item()
print(f"Final Model Thresholds - Layer1: {final_threshold1:.4f}, Layer2: {final_threshold2:.4f}")